...
| Arquivo | Formato | Para que serve o Renato? |
|---------|---------|---------------------|
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas do Renato de forma mais assertiva.
